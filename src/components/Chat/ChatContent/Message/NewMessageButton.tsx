...
const NewMessageButton = React.memo(
  ({ messageIndex }: { messageIndex: number }) => {
    ...
    return (
      ...
      >
        <div
          className='absolute top-0 translate-y-[-50%] text-gray-600 dark:text-white cursor-pointer bg-gray-200 dark:bg-gray-600/80 rounded-full p-1 text-sm hover:bg-gray-300 dark:hover:bg-gray-800/80 transition-bg duration-200'
          onClick={addMessage}
        >
          <PlusIcon />
        </div>
