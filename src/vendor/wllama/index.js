  ...
  moduleInit(ggufFiles) {
    return __async(this, null, function* () {
      ...
      this.worker.onerror = (ev) => {
        const msg = ev && ev.message ? `Worker error: ${ev.message} (${ev.filename}:${ev.lineno}:${ev.colno})` : 'Worker error (no message)';
